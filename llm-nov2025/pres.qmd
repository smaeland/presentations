...
::::{.columns}
:::{.column width="50%"}
:::{.absolute top="44%" left="2%" width="380px"}
...
![](figures/word2vec_1.png){width="70%"}
<!-- ::: -->

:::{.fragment fragment-index=1}
![](figures/word2vec_2.png){width="70%"}
:::

:::{.fragment fragment-index=2}
![](figures/word2vec_3.png){width="70%"}
:::

:::{.fragment fragment-index=3}
![](figures//word2vec_4.png){width="70%"}
:::
...
## {data-menu-title="(Self-)Attention is all you need" background-image="figures/attention-arxiv.png" background-size="contain" background-color="#ECEFF1"}
...
:::
For each element in a [query]{.blue}, compute how much it is related to every [key]{.orange}, and use these scores to weight a sum of [values]{.pink}
...
::::{.columns}
:::{.column width="70%"}
So far our transformation has **no learnable parameters**
...
- Pass each input ([query]{.blue}, [key]{.orange} and [value]{.pink}) though a separate neural network layer
...
## {data-menu-title="Attention is (still) all you need" background-image="figures/attention-arxiv.png" background-size="contain" background-color="#ECEFF1"}
...
![](figures/textgen.png){fig-align="center" width="80%"}
...
:::{style="padding-top: 40px;"}
:::
![](figures/beamsearch.png){fig-align="center" width="60%"}

:::{.fragment}
Need a [_sampling strategy_]{.teal}.
:::
