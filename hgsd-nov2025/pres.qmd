...
## {data-menu-title="Forside" background-image="../mat110-nov2024/figures/MAT110-flyer.png" background-position="top" background-size="cover"}
...
## {data-menu-title="Et enklere prediksjonsproblem" background-iframe="../mat110-nov2024/figures/linreg_data_only.html" background-interactive="true"}
...
## {data-menu-title="Et enklere prediksjonsproblem" background-iframe="../mat110-nov2024/figures/linreg_sliders.html" background-interactive="true"}
...
![](../mat110-nov2024/figures/lossfunction/image-1.png)

![](../mat110-nov2024/figures/lossfunction/image-2.png){.fragment fragment-index=1}

![](../mat110-nov2024/figures/lossfunction/image-3.png){.fragment fragment-index=2}

![](../mat110-nov2024/figures/lossfunction/image-4.png){.fragment fragment-index=3}

![](../mat110-nov2024/figures/lossfunction/image-5.png){.fragment fragment-index=4}

![](../mat110-nov2024/figures/lossfunction/image-6.png){.fragment fragment-index=5}

![](../mat110-nov2024/figures/lossfunction/image-7.png){.fragment fragment-index=6}

![](../mat110-nov2024/figures/lossfunction/image-8.png){.fragment fragment-index=7}
...
## {data-menu-title="Linreg med tapsfunksjon" background-iframe="../mat110-nov2024/figures/linreg_loss.html" background-interactive="true"}
...
## {data-menu-title="På fjellet" background-image="../mat110-nov2024/figures/mountain.jpg"}
...
:::{.fragment}
![](../mat110-nov2024/figures/2d_plot_example.png){fig-align="center" width="70%"}
:::
:::
...
![](../mat110-nov2024/figures/3d_plot_example.png){fig-align="center"}
:::
:::
::::
...
## {data-menu-title="Linreg med gradient" background-iframe="../mat110-nov2024/figures/linreg_gradient.html" background-interactive="true"}

## {data-menu-title="Høydekurver" background-image="../mat110-nov2024/figures/kart.png"}
...
![](../mat110-nov2024/figures/neuralnet.png){width="70%" fig-align="center"}

## {.center data-menu-title="Nevralnett aktivering"}

![](../mat110-nov2024/figures/neuralnet_activations.png){fig-align="center"}


## {data-menu-title="GPT parameterantall" background-image="../mat110-nov2024/figures/gpt-parameters.png"}

:::{.fragment .absolute left="15%" bottom="-50px" width="700px"}
![](../mat110-nov2024/figures/datacentre.jpg){fig-align="center"}
:::
...
![](../mat110-nov2024/figures/neuralnet.png)
:::
...
![](../mat110-nov2024/figures/simplevec.png){width="50%" fig-align="center"}
...
![](../mat110-nov2024/figures/vector-1d.png)
:::
...
![](../mat110-nov2024/figures/brain1.jpg){fig-align="right"}
:::
...
::::{.columns}
:::{.column width="50%"}
![](../mat110-nov2024/figures/vector-2d.png)
:::
...
:::{.absolute top="-40px" right="-80px" width="150px"}
![](../mat110-nov2024/figures/brain2.jpg){fig-align="right"}
:::
...
::::{.columns}
:::{.column width="50%"}
![](../mat110-nov2024/figures/vector-3d.png)
:::
...
:::{.absolute top="-40px" right="-80px" width="150px"}
![](../mat110-nov2024/figures/brain3.jpg){fig-align="right"}
:::
...
::::{.columns}
:::{.column width="30%"}
![](../mat110-nov2024/figures/vector-nd.png)
:::
...
:::{.absolute top="-40px" right="-80px" width="150px"}
![](../mat110-nov2024/figures/brain4.jpg){fig-align="right"}
:::
...
![](../mat110-nov2024/figures/word2vec/word2vec-1.png){width="70%"}

:::{.fragment fragment-index=1}
![](../mat110-nov2024/figures/word2vec/word2vec-2.png){width="70%"}
:::

:::{.fragment fragment-index=2}
![](../mat110-nov2024/figures/word2vec/word2vec-3.png){width="70%"}
:::

:::{.fragment fragment-index=3}
![](../mat110-nov2024/figures/word2vec/word2vec-4.png){width="70%"}
:::

:::

:::{.fragment fragment-index=3 .absolute top="0px" right="0px" width="350px"}
![](../mat110-nov2024/figures/roma.webp)
:::


## {background-image="../mat110-nov2024/figures/attention_is_all_you_need.png" background-position="top" background_size="cover"}
...
![](../mat110-nov2024/figures/attention_block.png){fig-align="center"}
:::
...
:::{style="padding-left: 20%;"}
<iframe width="800px" height="800px" src="../mat110-nov2024/figures/attention_plot.html"></iframe>
:::
...
![](../mat110-nov2024/figures/chatgpt.png){fig-align="center"}
:::
...
![](../mat110-nov2024/figures/thomas_calculus.webp){fig-align="center"}
:::
...
![](../mat110-nov2024/figures/edwards.webp){fig-align="center"}
:::
