...
## {data-menu-title="ChatGPT" .center background-color="#E1F5FE"}
...
![](figures/2d_plot_example.png){fig-align="center" width="80%"}
:::
...
\nabla L = 
\begin{bmatrix}
\frac{\partial \color{Purple}{f}}{\partial x} \\[0.2em]
\frac{\partial \color{Purple}{f}}{\partial y}
\end{bmatrix}
$$
